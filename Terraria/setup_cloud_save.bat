...
set LOCAL_DIR=%USERPROFILE%\Documents\My Games\Terraria

set SAVES_PARENT_DIR_NAME=
set SAVES_DIR_NAME=Worlds
set OLD_TIMESTAMP=old

set LOCAL_SAVES_DIR=%LOCAL_DIR%\%SAVES_PARENT_DIR_NAME%

set CLOUD_DIR=%USERPROFILE%\Google Drive\hackazor_cloud_saverino\Terraria
...
echo Do it manually, it won't work. Press Enter to continue
set /p next=
REM xcopy /e /v %LOCAL_SAVES_DIR%\%SAVES_DIR_NAME%_%OLD_TIMESTAMP% "%CLOUD_SAVES_DIR%\%SAVES_DIR_NAME%"
